  ...
  applicationForm: {
    ...
    form: {
      ...
      appDescription: {
        ...
        placeholder:
          'Describe the application scenario and use, e.g.: assistant answering user questions about product usage'
      },
      aiModel: {
        label: 'AI Model',
    ...
    dialogues: {
      ...
      designated_answer:
        'Hello, I am Assistant. My knowledge base only contains information related to products. Please rephrase your question.'
    }
  },
  prompt: {
    defaultPrompt:
    ...
    defaultPrologue:
      'Hello, I am Assistant. You can ask me questions about using .\n- What are the main features of ?\n- Which large language models does support?\n- What document types does support?'
  }
}
